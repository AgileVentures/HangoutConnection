    ...
    HangoutApplication.prototype.changeHoaStatus = function(e) {
      ...
      if (prev_hoa_status !== this.hoa_status) {
        ...
        if (this.hoa_status === 'finished') {
          ...
          return gapi.hangout.layout.displayNotice("Youtube url for this session is at: https://www.youtube.com/watch?v=" + gapi.hangout.onair.getYouTubeLiveId() + " And please share with us how your pairing went via email: info@agileventures.org");
        }
      }
    };
